...
public class LastFMArtistImageLoader implements StreamModelLoader<ArtistImage> {
    ...
    public LastFMArtistImageLoader(Context context, LastFMRestClient lastFMRestClient, ModelLoader<GlideUrl, InputStream> urlLoader) {
    ...
    public DataFetcher<InputStream> getResourceFetcher(ArtistImage model, int width, int height) {
        return new LastFMArtistImageFetcher(context, lastFMClient, model, urlLoader, width, height);
    }
    ...
    public static class Factory implements ModelLoaderFactory<ArtistImage, InputStream> {
        ...
        public ModelLoader<ArtistImage, InputStream> build(Context context, GenericLoaderFactory factories) {
            return new LastFMArtistImageLoader(context, lastFMClient, okHttpFactory.build(context, factories));
        }
